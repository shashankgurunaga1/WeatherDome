...
if(response.weather[0].main=="Fog"){
    document.body.style.backgroundImage = "url('images/fog.jpg')"
                    ...
                    display_string = display_string.concat('<br><div class="container"> <div class="card"><div class="card-body"><b>City Name: </b> ').concat(response.name).concat('<br/><b>Temp: </b>').concat((response.main.temp-273.15).toFixed(2)).concat("°C").concat('<br/><b>Description: </b>').concat(response.weather[0].description).concat('</div></div>,</div></br>');
